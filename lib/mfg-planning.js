...
function generateHorizontalPlan(MDO, log) {
    ...
    var ssMatrix = dataObjects.createMatrix(dataObjects.filter(MDO.inventory, {"class": "Safety Stock"}), "item", "period", "inventory");
    var llMatrix = dataObjects.createMatrix(dataObjects.filter(MDO.inventory, {"class": "Level Load"}), "item", "period", "inventory");
