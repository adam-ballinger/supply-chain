/**
 * @fileoverview Utility functions for resource management functions.
 * 
 * This module is a part of the supply-chain package used for resource management and supply chain
 * planning. The module is primarily focused on planning functions that involve processing and
 * computing data from a Common Data Set.
 * 
 ...
 * planning within a resource management context. The structure of the Common Data Set is as follows:
 * 
 * Common Data Set:
 * 
 *  {
...
/**
 * An algorith to create a build plan to level load constrained resources.
 * 
 ...
 * 
 * Each build plan entry contains an item's forecasted quantity for a specific period.
 * 
 */
function levelLoad(dataSet, log) {
    ...
    switch(log) {
        case "verbose":
            console.log({
                message: "Level load successful.",
                result: dataSet.buildPlan                
            })
            break;
...
module.exports = {getCommonDataSet, calcAvailableHours, levelLoad};