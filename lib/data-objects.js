...
/**
 * Calcs the number of weekdays in a month.
 * 
 * @param {Date} date - A date within the target month.
 * @returns {number} The number of workdays in the target month.
 */
function getWeekdaysInMonth(date) {
...
/**
 * UNFINISHED - Sorts data by specified columns and criteria
 * 
 * 
 * @return {Object} A sorted data object.
 */
function sort(column, sortMethod) {
