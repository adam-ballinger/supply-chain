...
/**
 * 
 * @param {Array} matrices Array of matrices to be summed.
 * @returns A matrix that is the sum of all matrices.
 */
...
module.exports = {matrix_mult, scalar_mult, difference, piecewiseDivision, sum};